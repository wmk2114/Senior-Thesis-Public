...
- ChatGPT was used to create functions, implmenting inverse covariance weighting and principal component aalysis. Claude was used to confirm that the implementation was correct, and I also reviewed the generated code myself, comparing it reputable scholarship on how to use both ICW and PCA.
